    ...
    <div class="w3-row">
      <div class="w3-content">
        <div class="w3-theme-l4 w3-container w3-small">
          <a href="index.php" style="color:#0000ff;">Home</a> > Git
        </div>
      </div>
    </div>
            ...
            <div class="w3-content">
              ...
              <div class="w3-card-4 w3-margin w3-white">
                ...
                <div class="w3-container w3-twothird w3-white">
                  <p>
                    Revision control, a.k.a. source countrol, a.k.a. change control, often generalized as “git,” whatever you call it, is a critical concept to learn to use in an IT career.
                  </p>
                  <br>
                </div>
                <div class="w3-container w3-third w3-white w3-center">
                  <a href="https://git-scm.com/" target="_blank" style="color:#0000ff;"><img src="images\GitLogo.png" height="70%" width="70%" alt="Mug" title="Git"></a>
                </div>
              </div>
              </div>
            </div>
            ...
            <div class="w3-content">
              <div class="w3-card-4 w3-margin w3-white">
                ...
                <div class="w3-container">
                  <p>
                    <ul>
                      <li>I incorporate Git technology and training in all of my classes as I believe everyone in IT should be familiar with Git technology and interfaces to Git projects.</li>
                    </ul>
                  </p>
                  <br>
                </div>
            ...
            <div class="w3-content">
              <div class="w3-card-4 w3-margin w3-white">
                ...
                <div class="w3-container">
                  ...
                  <div class="w3-row">
                    <div class="w3-container w3-twothird w3-white w3-left">
                      <p>
                        <ul>
                          <li>February 12, 2020: Salt Lake Community College (SLCC) Computer Club Presentation. Git Technology & GitHub.</li>
                        </ul>
                      </p>
                    </div>
                    <div class="w3-container w3-third w3-white w3-center">
                      <img src="images\SLCCGitPresentation02122020.jpg" height="100%" width="100%" alt="Mug" title="SLCC Git Presentation">
                    </div>
                  </div>
        ...
        <div class="w3-theme-l3 w3-container">
          <div class="w3-row">
            <div class="w3-content">
              <div class="w3-card-4 w3-margin w3-white">
                <div class="w3-container">
                  <h4>Git Books I Like</h4>
                </div>
                <div class="w3-container">
                  <p>
                    <ul>
                      <li><a style="color:#0000ff;" target="_blank" href="https://git-scm.com/book/en/v2">Pro Git</a>, 2014, Scott Chacon. This is a free online book that provides good coverage of Git technology.</li>
                    </ul>
                  </p>
                  <br>
                </div>
