    ...
    <div class="w3-row">
      <div class="w3-content">
        <div class="w3-theme-l4 w3-container w3-small">
          <a href="index.php" style="color:#0000ff;">Home</a> > <a href="java.php" style="color:#0000ff;">SQL</a> > CSIS-1400 Fundamentals of Computer Programming
        </div>
      </div>
    </div>
    ...
    <div class="w3-row">
      <div class="w3-content">
        <div class="w3-twothird w3-container w3-theme-l1">
          <h4>CSIS-1400 <i>Fundamentals of Computer Programming</i></h4>
        </div>
          ...
          <div class="w3-row">
            <div class="w3-content">
              <div class="w3-card-4 w3-margin w3-white">
                ...
                <div class="w3-container">
                  <p>
                    I teach CSIS-1400 at <a href="http://www.slcc.edu/" style="color:#0000ff;" target="_blank">Salt Lake Community College (SLCC)<a> which is a course in the Computer Science & Informations Systems Department that provides students with a ..............................
                  </p>
                </div>
                <div class="w3-container">
                  <h4>My CSIS-1400 Course Outline</h4>
                </div>
                <div class="w3-container">
