    ...
    <div class="w3-row">
      <div class="w3-content">
        <div class="w3-theme-l4 w3-container w3-small">
          <a href="HomePage.html" style="color:#0000ff;">Home</a> ______ > ______ > ______ > ______
        </div>
      </div>
    </div>
...
-->
    ...
    <div class="w3-row">
      <div class="w3-content w3-center w3-small">
        <p>&copy; 2020 <a href="Contact.html" style="color:#0000ff;">John Calvin Gordon</a>. All rights reserved.</p>
        <br>
        <br>
      </div>
    </div>
