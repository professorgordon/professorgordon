    ...
    <div class="w3-row">
      <div class="w3-content">
        <div class="w3-theme-l4 w3-container w3-small">
          <a href="HomePage.html" style="color:#0000ff;">Home</a> > Java
        </div>
      </div>
    </div>
        ...
        <div class="w3-theme-l3 w3-container">
          <div class="w3-row">
            <div class="w3-content">
              <div class="w3-card-4 w3-margin w3-white">
                <div class="w3-container">
                  <h4>Information & Practic e</h4>
                </div>
                <div class="w3-container">
                  <p>
                    <ul>
                      <li><a href="beginningjava.html" style="color:#0000ff;">Beginning Java</a> [CSIS-1340, CSIS-1400 or equivalent]</li>
