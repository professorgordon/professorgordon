    ...
    <div class="w3-row">
      <div class="w3-content">
        <div class="w3-theme-l4 w3-container w3-small">
          <a href="HomePage.html" style="color:#0000ff;">Home</a> > <a href="java.html" style="color:#0000ff;">Java</a> > Beginning Java
        </div>
      </div>
    </div>
                ...
                <div class="w3-container">
                  <p>
                    <ul>
                      ...
                      <li>Java Project Structure</li>
                      <li>Basic Structure of a Java Program</li>
        ...
        <div class="w3-theme-l3 w3-container">
          <div class="w3-row">
            <div class="w3-content">
              <div class="w3-card-4 w3-margin w3-white">
                <div class="w3-container">
                  <h4>Java Programming Practice Problems</h4>
                </div>
                <div class="w3-container">
                  <p>
                    <ul>
