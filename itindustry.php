            ...
            <div class="w3-content">
              <div class="w3-card-4 w3-margin w3-white">
                <div class="w3-container">
                  <h4>Connections to the IT Industry</h4>
                </div>
                <div class="w3-container">
                  <p>As an educator, with over 30 years of work in the IT Industry, I am interested in bringing my experiences into the educational environment in ways that will help to inform and inspire students and others to be successful in finding their own path from where they are today into a future lucrative IT career.</p>
                  <br>
                </div>
              </div>
            </div>
        ...
        <div class="w3-theme-l3 w3-container">
          <div class="w3-row">
            <div class="w3-content">
              <div class="w3-card-4 w3-margin w3-white">
                <div class="w3-container">
                  <h4>IT Industry Books I Like</h4>
                </div>
                <div class="w3-container">
                  <p>
                    <i>Forthcoming</i><br>
